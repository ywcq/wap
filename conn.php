...
//代理数据库链接
$hostname_conn = "8.134.175.182";//写的127的一般不需要改 除非你不是本机搭建的代理系统
...
$server_name = array(
						1=>array(
							"name"=>"一区:游蚊天下",				//显示名称
							"host"=>"8.134.175.182",		//服务器IP	一区如果是和代理在一个机器上不用改		
							"root"=>"root",				//数据库用户名
						...
						2=>array(
							"name"=>"二区:游蚊再现（筹备中）",
							"host"=>"8.134.175.182",		//服务器数据库要开放外部访问权限 二区需要在另外的服务器放权限 待会单独教学
							"root"=>"root",
							"pass"=>"6836280aa",   
							"prot"=>"3306",	//数据库端口							
							"token"=>"dofQgzAUHbjXyOEh",	//支付平台分区的回调秘钥
