...
<body>
 	<div class="wrap">
 		...
 		<div class="from-box">
 			...
 			<div class="loginbtn"><input type="button" onclick="location.href='https://www.123pan.com/s/Z9FDVv-HXqjh.html'" class="reg" value="安卓下载"><input type="button" onclick="location.href='https://qm.qq.com/cgi-bin/qm/qr?k=9YEwP5DCYtikgYNZumO7-wlNBZnB3LY-&jump_from=webapi&authKey=68+K8+/NOSbCrk344TWDNkC59TJA7JsvPclmD6Dk6Ny6QEdNKvf1XSeZELjMtlrI'" class="zhao" value="苹果下载"></div>
